...
-- copied from https://github.com/juniorsundar/nvim/blob/534554a50cc468df0901dc3861e7325a54c01457/lua/config/lsp/breadcrumbs.lua
local configure_breadcrumbs = function()
	...
	local function breadcrumbs_set()
	    ...
	    elseif not clients[1].supports_method('textDocument/documentSymbol') then
		    print("Error: LSP client does not support documentSymbols. Skipping breadcrumbs.")
	        --return
	    end
