# Generated by Powerlevel10k configuration wizard on 2021-08-31 at 18:50 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='sledge|k|docker|docker-compose|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern'
  ...
  function p10k-on-pre-prompt() {
    ...
    p10k display '1'=show '2/right/command_execution_time'=hide
  }
  function p10k-on-post-prompt() {
    # Hide the first prompt line.
    p10k display '1'=hide '2/right/command_execution_time'=show
  }
