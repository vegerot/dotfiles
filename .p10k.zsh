# Generated by Powerlevel10k configuration wizard on 2024-07-24 at 14:35 PDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status
	my_sapling_status		# sapling status @@@ ME
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    vpn_ip                  # virtual private network indicator @@@ ME
    # load                  # CPU load
  ...
  p10k-on-pre-prompt() p10k display empty_line=print # @@@ ME
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=255 # @@@ ME
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=0 # @@@ ME
  # Custom icon.
  ...
  # @@@ me
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='sledge|k|docker|docker-compose|kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|cmctl|sparkctl'
  ...
  ################################[ battery: internal battery ]#################################
  typeset -g POWERLEVEL9K_BATTERY_HIDE_ABOVE_THRESHOLD=25 # @@@ ME
  ...
  typeset -g POWERLEVEL9K_TRANSIENT_PROMPT=same-dir # @@@ ME
